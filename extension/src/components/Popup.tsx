  ...
  return (
    <div className="w-full h-full flex flex-col justify-between items-center bg-gradient-to-br from-gray-900 to-gray-700 text-white text-center shadow-xl rounded-lg">
      ...
      <div className="w-full px-6 pb-6 text-lg">
        <button
          className="w-full py-3 font-semibold bg-gray-800 hover:bg-gray-700 hover:scale-105 transition duration-300 rounded-lg"
          onClick={() =>
            window.open(
              "https://note-mate-hackathon.vercel.app",
              "_blank",
              "noopener noreferrer"
            )
          }
          aria-label="Sign up on website"
        >
          Sign Up
        </button>
